...
import './aprioriStockResult.css';
import StockDataYahoo from '../../models/StockDataYahoo';
import YahooData from '../../models/YahooData';
import AprioriStockAnalysis from '../../models/AprioriStockAnalysis';
...
const AprioriStockResult = () => {
    ...
    async function reloadData() {
        ...
        await getStockDataFromYahoo(symbols, aprioriStockAnalysis?.interval);
    ...
    function getCondition() {
        const firstCondition = aprioriStockAnalysis?.firstCondition;
        const secondCondition = aprioriStockAnalysis?.secondCondition;
    ...
    function checkCondition(symbol: string) {
        ...
        if (stockCondition.previous === true) {
            if (aprioriStockAnalysis?.stockCondition === '>') {
                                    ...
                                    <div className='main-apriori-result-right-top'>
                                        ...
                                        <div>
                                            ...
                                            <div className='main-apriori-result-right-top-time-box'>
                                                <p>{formateDate(aprioriStockAnalysis?.startDate)}</p>
                                                <p className='main-apriori-result-right-top-time-box-middle'>até</p>
                                                <p>{aprioriStockAnalysis?.endDate === undefined ? formateDate(getToday()) : formateDate(aprioriStockAnalysis?.endDate)}</p>
                                            </div>
                                        </div>
                                        <div className='main-apriori-result-right-top-interval-box'>
                                            ...
                                            <p>{aprioriStockAnalysis?.interval}</p>
                                        </div>
                                        <div className='main-apriori-result-right-top-filter-box'>
                                            <div className='main-apriori-result-right-top-time-box'>
                                                ...
                                                <p>{aprioriStockAnalysis?.minSupport.toString() === 'null' ? 'Nenhum' : aprioriStockAnalysis?.minSupport}</p>
                                            </div>
                                            <div className='main-apriori-result-right-top-time-box'>
                                                <p className='main-apriori-result-right-top-interval-box-title'>Confiança mínima:</p>
                                                <p>{aprioriStockAnalysis?.minConfidence.toString() === 'null' ? 'Nenhum' : aprioriStockAnalysis?.minConfidence}</p>
                                            </div>
                                            <div className='main-apriori-result-right-top-time-box'>
                                                <p className='main-apriori-result-right-top-interval-box-title'>Lift mínimo:</p>
                                                <p>{aprioriStockAnalysis?.minLift.toString() === 'null' ? 'Nenhum' : aprioriStockAnalysis?.minLift}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
